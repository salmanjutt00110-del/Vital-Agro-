      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-white mt-4 tracking-tight">
            {lang === 'en' ? 'Interactive Premium Showroom' : 'پریمیئم پراڈکٹ شو روم'}
          </h2>
          <p className="text-white/60 text-base sm:text-lg max-w-2xl mx-auto mt-4">
            {lang === 'en' 
              ? 'Explore our world-class bio-stimulants and plant protections using an Apple-level 3D glassmorphic card deck.' 
              : 'جدید ترین ریسرچ فارمولیشنز کی تفصیلات دیکھنے اور خریدنے کے لیے شو روم دیکھیں۔'}
          </p>
        </div>
