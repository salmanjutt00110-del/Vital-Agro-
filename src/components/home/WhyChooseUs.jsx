        ...
        <div className="grid lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-5 flex">
            <motion.div
              ...
              className="w-full relative rounded-3xl overflow-hidden border border-white/10 bg-white/[0.02] flex flex-col justify-between p-8 group shadow-2xl min-h-[360px]"
            >
              ...
              <div className="relative flex-1 flex items-center justify-center py-6">
                ...
                <img
                  ...
                  className="max-h-[220px] w-auto object-contain drop-shadow-[0_15px_30px_rgba(0,0,0,0.5)] group-hover:scale-105 group-hover:rotate-2 transition-all duration-700"
                />
              </div>
