...
export default function ProductShowcase() {
  ...
  const labels = {
    en: {
      ...
      freeShipping: "FREE Shipping on JazzCash, Easypaisa & Bank Transfer! 🎁",
      codCharges: "COD charges PKR 299 shipping at your door.",
      codAvailable: "COD available nationwide. Pay on delivery.",
    ...
    ur: {
      ...
      freeShipping: "جاز کیش، ایزی پیسہ اور بینک ٹرانسفر پر فری ڈلیوری! 🎁",
      codCharges: "کیش آن ڈلیوری پر ڈلیوری چارجز 299 روپے لاگو ہوں گے۔",
      codAvailable: "پورے پاکستان میں کیش آن ڈلیوری دستیاب ہے۔",
