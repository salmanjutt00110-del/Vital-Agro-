          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div className="lg:col-span-1">
              ...
              <div className="flex gap-3">
                ...
                <a
                  href="mailto:info@vitalagro.com.pk"
                  className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#76C945] transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-[#76C945]/20"
                >
            ...
            <div>
              ...
              <ul className="space-y-5">
                {[
                  { icon: MapPin, value: 'Plot # 50 & 68, Vital House, Nawababad, Wah Cantt, Pakistan' },
                  { icon: Phone, value: '063-2253137' },
                  { icon: Mail, value: 'info@vitalagro.com.pk' },
                ].map((item, i) => (
